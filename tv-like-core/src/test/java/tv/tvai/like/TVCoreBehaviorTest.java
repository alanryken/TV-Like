...
public class TVCoreBehaviorTest {
    ...
    @Test
    public void shouldSortMatchedSectionsByDomOrderAcrossRules() {
        String html = "<html><body>"
                ...
                + "<ul class='latest'><li><a href='/detail/3'>片名3</a></li></ul>"
                + "<script type='application/yaml' name='tv-like'>"
                + "version: 1\n"
                + "sections:\n"
                + "  - name: nav\n"
        ...
        Assert.assertEquals("latest", result.get(0).getSection());
        Assert.assertEquals("片名1", result.get(0).getItems().getList().get(0).getText().getValue());
        Assert.assertEquals("nav", result.get(1).getSection());
        Assert.assertEquals("电影", result.get(1).getText().getValue());
        Assert.assertEquals("latest", result.get(2).getSection());
        Assert.assertEquals("片名2", result.get(2).getItems().getList().get(0).getText().getValue());
        Assert.assertEquals("nav", result.get(3).getSection());
        Assert.assertEquals("电视剧", result.get(3).getText().getValue());
        Assert.assertEquals("latest", result.get(4).getSection());
        Assert.assertEquals("片名3", result.get(4).getItems().getList().get(0).getText().getValue());
    }
